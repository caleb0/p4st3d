...
public:
	...
	CColor FromHSB(float hue, float saturation, float brightness)
	{
	...
	static CColor LightBlue() { return CColor(100, 100, 255); }
	static CColor Grey() { return CColor(128, 128, 128); }
	static CColor DarkGrey() { return CColor(45, 45, 45); }
	static CColor Black() { return CColor(0, 0, 0); }
	static CColor White() { return CColor(255, 255, 255); }
	static CColor Purple() { return CColor(220, 0, 220); }
